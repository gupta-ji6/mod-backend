...
public interface MentorRepository extends Repository<Mentor, Integer> {
	...
	@Query("select mentor from Mentor mentor where mentor.role=? and mentor.userName=? and mentor.password=?")
	Mentor findMentor(String role, String userName, String password);
}
