...
public class TrainingServiceImpl implements TrainingService {
	...
	@Override
	public Training findByIdAndUser(Integer id, Integer userId) {
		return repository.findByIdAndUser(id, userId);
	}

	@Override
	public List<Training> findByStartDateBetween(Date dateStart, Date dateEnd) {
		return repository.findByStartDateBetween(dateStart, dateEnd);
	}
